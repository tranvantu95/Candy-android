...
//    final Point desiredLocation = new Point(0, Utils.screenHeight(context) - popupWindow.getHeight());
      ...
      if (null == emojiEditText) {
          desiredLocation = new Point(0, Utils.screenHeight(context) - popupWindow.getHeight());
      } else {
          int[] location = new int[2];
          emojiEditText.getLocationOnScreen(location);
          desiredLocation = new Point(0, location[1] + emojiEditText.getHeight());
      }
